...
<html>
<head>
    <title>Login - Sparkera System</title>
...
<body>
    <div class="container">
        <h2>Sparkera Login System</h2>
        <% String error = request.getParameter("error"); String success = request.getParameter("registered"); String reset = request.getParameter("reset"); %>
        <% if ("1".equals(success)) { %>
        ...
        <div class="links">
            <a href="<%= contextPath %>/register.jsp">Create New Account</a> | <a href="<%= contextPath %>/forgot-password.jsp">Forgot Password?</a>
        </div>
    </div>
</body>
</html>